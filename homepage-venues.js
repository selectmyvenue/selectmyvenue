(function () {
  ...
  function installFoundingPartnerOffer() {
    ...
    style.textContent = `
      ...
      #mainNav a.smv-owner-nav-offer{position:relative;padding:10px 16px;border:1px solid rgba(243,200,75,.42);border-radius:999px;color:#ffe47a!important;background:linear-gradient(180deg,rgba(243,200,75,.07),rgba(243,200,75,.025));animation:smvOwnerNavGlow 2.4s ease-in-out infinite}
      #mainNav a.smv-owner-nav-offer::before{content:"FREE";position:absolute;top:-9px;right:-8px;min-width:31px;height:17px;padding:0 5px;display:grid;place-items:center;border-radius:999px;background:#19d8bd;color:#02211c;font-size:7px;font-weight:1000;letter-spacing:.08em;box-shadow:0 0 14px rgba(25,216,189,.35)}
      #mainNav a.smv-owner-nav-offer::after{display:none!important}
      #mainNav a.smv-header-phone{display:inline-flex;align-items:center;gap:7px;color:#f3fbfa!important;font-weight:900;white-space:nowrap}
      #mainNav a.smv-header-phone::before{content:"☎";color:#19d8bd;font-size:14px}
      #mainNav a.smv-header-phone:hover{color:#19d8bd!important}
    ...
    if (contactLink) {
      ...
      contactLink.classList.add("smv-header-phone");
