(function () {
  ...
  function installFoundingPartnerOffer() {
    ...
    style.textContent = `
      ...
      /* Premium, settled header action cluster */
      #mainNav .smv-header-action{min-height:48px;box-sizing:border-box;display:inline-flex;align-items:center;justify-content:center;border-radius:999px;transition:transform .2s ease,border-color .2s ease,background .2s ease,box-shadow .2s ease,color .2s ease}
      #mainNav a.smv-find-nav{padding:0 20px!important;border:1px solid rgba(25,216,189,.48)!important;background:linear-gradient(180deg,rgba(25,216,189,.09),rgba(25,216,189,.025))!important;color:#2ce3ca!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.035),0 8px 24px rgba(0,0,0,.12)}
      #mainNav a.smv-find-nav:hover{transform:translateY(-1px);border-color:rgba(25,216,189,.75)!important;background:rgba(25,216,189,.12)!important;box-shadow:0 8px 26px rgba(25,216,189,.10)}
      #mainNav a.smv-find-nav::after{display:none!important}
      #mainNav a.smv-header-phone{position:relative;padding:0 17px!important;gap:9px;color:#f3fbfa!important;font-weight:950;white-space:nowrap;border:1px solid rgba(25,216,189,.18);background:linear-gradient(180deg,rgba(255,255,255,.025),rgba(25,216,189,.025));box-shadow:inset 0 1px 0 rgba(255,255,255,.025)}
      #mainNav a.smv-header-phone::before{content:"☎";width:27px;height:27px;display:grid;place-items:center;border-radius:50%;color:#02211c;background:linear-gradient(135deg,#2ce3ca,#19d8bd);font-size:13px;line-height:1;box-shadow:0 0 16px rgba(25,216,189,.18)}
      #mainNav a.smv-header-phone::after{display:none!important}
      #mainNav a.smv-header-phone:hover{transform:translateY(-1px);color:#fff!important;border-color:rgba(25,216,189,.42);background:rgba(25,216,189,.065);box-shadow:0 8px 24px rgba(0,0,0,.13)}
      #mainNav a.smv-owner-nav-offer{position:relative;padding:0 20px!important;border:1px solid rgba(243,200,75,.52);border-radius:999px;color:#ffe47a!important;background:linear-gradient(180deg,rgba(243,200,75,.09),rgba(243,200,75,.025));box-shadow:inset 0 1px 0 rgba(255,255,255,.035),0 8px 24px rgba(0,0,0,.12);animation:smvOwnerNavGlow 2.4s ease-in-out infinite}
      #mainNav a.smv-owner-nav-offer::before{content:"FREE";position:absolute;top:-10px;right:10px;min-width:34px;height:18px;padding:0 6px;display:grid;place-items:center;border-radius:999px;border:2px solid #031817;background:#19d8bd;color:#02211c;font-size:7px;font-weight:1000;letter-spacing:.08em;box-shadow:0 0 14px rgba(25,216,189,.28)}
      #mainNav a.smv-owner-nav-offer::after{display:none!important}
      #mainNav a.smv-owner-nav-offer:hover{transform:translateY(-1px);border-color:rgba(243,200,75,.82);background:rgba(243,200,75,.105);box-shadow:0 8px 26px rgba(243,200,75,.10)}
      ...
      @keyframes smvOwnerNavGlow{0%,100%{box-shadow:inset 0 1px 0 rgba(255,255,255,.035),0 8px 24px rgba(0,0,0,.12)}50%{box-shadow:inset 0 1px 0 rgba(255,255,255,.035),0 8px 26px rgba(243,200,75,.10)}}
