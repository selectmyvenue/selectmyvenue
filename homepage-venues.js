(function () {
  ...
  function installFoundingPartnerOffer() {
    ...
    style.textContent = `
      /* Site-safe homepage readability boost */
      html body{font-size:17px!important;line-height:1.66!important;-webkit-font-smoothing:antialiased!important;text-rendering:optimizeLegibility!important}
      body p,body li,body small,body input,body select,body textarea,body button{font-size:clamp(15px,0.98vw,17px)!important;line-height:1.62!important}
      #mainNav>a{font-size:15px!important;font-weight:850!important}.hero-text,.section-heading>p,.popular-heading>p,.about-copy p,.contact-section>p{font-size:17px!important;line-height:1.75!important;font-weight:650!important}.field label,.planner-field label,.planner-extra label{font-size:12px!important}.field input,.field select,.field textarea,.planner-field input,.planner-field select,.planner-extra textarea{font-size:16px!important}.primary-btn,.secondary-btn{font-size:15px!important;font-weight:950!important}.home-venue-content h3{font-size:24px!important}.home-venue-location,.home-venue-content p{font-size:15px!important}.home-venue-fact span{font-size:11px!important}.home-venue-fact strong{font-size:15px!important}.home-venue-features span{font-size:12px!important}.contact-card strong{font-size:16px!important}.contact-card span{font-size:14px!important}.contact-card small{font-size:12px!important}.footer-link-group h4{font-size:13px!important}.footer-link-group a,.footer-bottom{font-size:13px!important}
      @media(max-width:620px){html body{font-size:16px!important}body p,body li,body small,body input,body select,body textarea,body button{font-size:15px!important}.hero-text,.section-heading>p,.popular-heading>p,.about-copy p,.contact-section>p{font-size:15.5px!important}}

      /* Original-style WhatsApp floating button */
      .floating-whatsapp{position:fixed!important;right:22px!important;bottom:22px!important;z-index:9999!important;width:62px!important;height:62px!important;min-width:62px!important;min-height:62px!important;padding:0!important;border-radius:50%!important;display:grid!important;place-items:center!important;background:#25D366!important;color:#fff!important;border:3px solid #fff!important;box-shadow:0 14px 34px rgba(0,0,0,.28),0 0 0 8px rgba(37,211,102,.12)!important;text-decoration:none!important;transition:transform .18s ease,box-shadow .18s ease!important}
      .floating-whatsapp:hover{transform:translateY(-3px) scale(1.04)!important;box-shadow:0 18px 40px rgba(0,0,0,.34),0 0 0 10px rgba(37,211,102,.14)!important}
      .floating-whatsapp-icon{width:36px!important;height:36px!important;display:grid!important;place-items:center!important;color:#fff!important;background:transparent!important;border-radius:0!important}.floating-whatsapp-icon svg{width:36px!important;height:36px!important;display:block!important;color:#fff!important}.floating-whatsapp-text{position:absolute!important;right:76px!important;top:50%!important;transform:translateY(-50%)!important;padding:10px 13px!important;border-radius:999px!important;background:#075E54!important;color:#fff!important;font-size:13px!important;font-weight:900!important;white-space:nowrap!important;box-shadow:0 10px 24px rgba(0,0,0,.20)!important;opacity:0!important;pointer-events:none!important;transition:.18s ease!important}.floating-whatsapp:hover .floating-whatsapp-text{opacity:1!important;right:82px!important}
      @media(max-width:620px){.floating-whatsapp{right:14px!important;bottom:14px!important;width:56px!important;height:56px!important;min-width:56px!important;min-height:56px!important}.floating-whatsapp-icon,.floating-whatsapp-icon svg{width:32px!important;height:32px!important}.floating-whatsapp-text{display:none!important}}
      ...
      .smv-owner-launch-kicker{display:inline-flex;align-items:center;gap:10px;min-height:36px;padding:0 14px;border-radius:999px;border:1px solid rgba(25,216,189,.45);color:#20dcc3;background:rgba(25,216,189,.055);font-size:12px!important;font-weight:950;letter-spacing:.13em;text-transform:uppercase}
      ...
      .smv-owner-launch-heading{margin:14px 0 8px;max-width:900px;color:#f3fbfa;font-size:clamp(38px,4.2vw,68px);line-height:.98;font-weight:1000;letter-spacing:-.045em}
      ...
      .smv-owner-launch-copy{max-width:880px;margin:0;color:#a9cbc6;font-size:16px!important;line-height:1.7!important}
      .smv-owner-launch-chips{display:flex;flex-wrap:wrap;gap:9px;margin-top:16px}
      .smv-owner-launch-chips span{display:inline-flex;align-items:center;min-height:38px;padding:0 14px;border-radius:13px;border:1px solid rgba(25,216,189,.25);color:#f3fbfa;background:rgba(25,216,189,.055);font-size:12px!important;font-weight:900;white-space:nowrap}
      ...
      .smv-owner-launch-right h3{margin:0 0 12px;color:#fff;font-size:22px!important;line-height:1.2;font-weight:950}
      .smv-owner-launch-benefit-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px 16px}
      .smv-owner-launch-benefit{display:flex;gap:9px;align-items:flex-start;color:#c4dcda;font-size:14px!important;line-height:1.45!important}
      ...
      .smv-owner-launch-cta{display:inline-flex;align-items:center;justify-content:center;min-height:50px;padding:0 20px;border-radius:14px;border:1px solid rgba(31,235,207,.52);background:linear-gradient(135deg,#20dcc3,#0fc8b0);color:#02211c;font-size:14px!important;font-weight:1000;text-decoration:none;white-space:nowrap;box-shadow:0 12px 30px rgba(15,200,176,.18);animation:smvHomepageCtaPulse 2.1s ease-in-out infinite;transition:.2s ease}
      .smv-owner-launch-cta:hover{transform:translateY(-2px);filter:brightness(1.05)}
      .smv-owner-launch-trust{margin-top:11px;color:#8fb8b3;font-size:12px!important;line-height:1.55!important}

      /* Compact but clearly separated desktop navigation */
      .header-inner{padding-left:18px!important;padding-right:18px!important;gap:12px!important}
      .brand{width:170px!important;flex:0 0 170px!important}.brand img{width:160px!important}
      #mainNav{min-width:0!important;gap:5px!important;margin-left:auto!important;justify-content:flex-end!important;align-items:center!important}
      #mainNav>a:not(.smv-header-action){position:relative;display:inline-flex!important;align-items:center;justify-content:center;min-height:40px;padding:0 10px!important;border-radius:10px;color:#b9cfcc!important;font-size:15px!important;font-weight:850!important;white-space:nowrap;background:rgba(255,255,255,.018);border:1px solid transparent;transition:.18s ease}
      #mainNav>a:not(.smv-header-action)::after{display:none!important}
      #mainNav>a:not(.smv-header-action):hover{color:#f3fbfa!important;background:rgba(25,216,189,.07);border-color:rgba(25,216,189,.13)}
      #mainNav>a:not(.smv-header-action).active{color:#fff!important;background:rgba(25,216,189,.09);border-color:rgba(25,216,189,.2);box-shadow:inset 0 -2px 0 #19d8bd}
      #mainNav .smv-header-action{min-height:42px;box-sizing:border-box;display:inline-flex;align-items:center;justify-content:center;border-radius:999px;font-size:15px!important;transition:transform .2s ease,border-color .2s ease,background .2s ease,box-shadow .2s ease,color .2s ease}
      #mainNav a.smv-find-nav{padding:0 14px!important;border:1px solid rgba(25,216,189,.48)!important;background:linear-gradient(180deg,rgba(25,216,189,.09),rgba(25,216,189,.025))!important;color:#2ce3ca!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.035),0 7px 20px rgba(0,0,0,.11)}
      #mainNav a.smv-find-nav::after{display:none!important}
      #mainNav a.smv-header-phone{position:relative;padding:0 12px!important;gap:7px;color:#f3fbfa!important;font-weight:950!important;white-space:nowrap;border:1px solid rgba(25,216,189,.18);background:linear-gradient(180deg,rgba(255,255,255,.025),rgba(25,216,189,.025));box-shadow:inset 0 1px 0 rgba(255,255,255,.025)}
      #mainNav a.smv-header-phone::before{content:"☎";width:24px;height:24px;display:grid;place-items:center;border-radius:50%;color:#02211c;background:linear-gradient(135deg,#2ce3ca,#19d8bd);font-size:11px;line-height:1;box-shadow:0 0 14px rgba(25,216,189,.16)}
      #mainNav a.smv-header-phone::after{display:none!important}
      #mainNav a.smv-owner-nav-offer{position:relative;padding:0 14px!important;border:1px solid rgba(243,200,75,.52);border-radius:999px;color:#ffe47a!important;background:linear-gradient(180deg,rgba(243,200,75,.09),rgba(243,200,75,.025));box-shadow:inset 0 1px 0 rgba(255,255,255,.035),0 7px 20px rgba(0,0,0,.11);animation:smvOwnerNavGlow 2.4s ease-in-out infinite}
      ...
      @media(max-width:1650px){.header-inner{padding-left:14px!important;padding-right:14px!important;gap:8px!important}.brand{width:155px!important;flex-basis:155px!important}.brand img{width:146px!important}#mainNav{gap:4px!important}#mainNav>a:not(.smv-header-action){font-size:14px!important;padding:0 7px!important;min-height:38px}#mainNav .smv-header-action{font-size:14px!important;min-height:40px}#mainNav a.smv-find-nav{padding:0 11px!important}#mainNav a.smv-header-phone{padding:0 9px!important;gap:5px}#mainNav a.smv-owner-nav-offer{padding:0 11px!important}}
      @media(max-width:1450px){#mainNav a[href="#aiPlanner"],#mainNav a[href="delhi-ncr-venues.html"]{display:none!important}.brand{width:150px!important;flex-basis:150px!important}.brand img{width:142px!important}#mainNav>a:not(.smv-header-action){font-size:13.5px!important;padding:0 8px!important}}

      #home{min-height:430px!important}#home .hero-inner{min-height:430px!important;padding-top:54px!important;padding-bottom:48px!important}#home h1{font-size:clamp(44px,4.8vw,76px)!important;line-height:1.01!important}
      ...
      @media(max-width:760px){.smv-owner-launch-wrap{padding:12px}.smv-owner-launch-panel{padding:18px 16px;border-radius:21px}.smv-owner-launch-heading{font-size:clamp(38px,11vw,52px)}.smv-owner-launch-benefit-grid{grid-template-columns:1fr}.smv-owner-launch-copy{font-size:14px!important}.smv-owner-launch-limited{font-size:11px!important}#home{min-height:390px!important}#home .hero-inner{min-height:390px!important;padding-top:42px!important;padding-bottom:40px!important}}
      @media(max-width:520px){.smv-owner-launch-kicker{font-size:9px!important;min-height:32px;padding:0 11px}.smv-owner-launch-heading{font-size:40px}.smv-owner-launch-chips{gap:7px}.smv-owner-launch-chips span{min-height:34px;padding:0 10px;font-size:10px!important}.smv-owner-launch-right{padding:16px}.smv-owner-launch-right h3{font-size:18px!important}.smv-owner-launch-cta{width:100%;font-size:12px!important}}
