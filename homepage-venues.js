(function () {
  ...
  function installFoundingPartnerOffer() {
    ...
    style.textContent = `
      ...
      #mainNav>a:not(.smv-header-action){position:relative;display:inline-flex!important;align-items:center;justify-content:center;min-height:38px;padding:0 9px!important;border-radius:10px;color:#b9cfcc!important;font-size:14px!important;font-weight:760!important;white-space:nowrap;background:rgba(255,255,255,.018);border:1px solid transparent;transition:.18s ease}
      ...
      #mainNav .smv-header-action{min-height:42px;box-sizing:border-box;display:inline-flex;align-items:center;justify-content:center;border-radius:999px;font-size:14px!important;transition:transform .2s ease,border-color .2s ease,background .2s ease,box-shadow .2s ease,color .2s ease}
      ...
      @media(max-width:1650px){.header-inner{padding-left:14px!important;padding-right:14px!important;gap:8px!important}.brand{width:155px!important;flex-basis:155px!important}.brand img{width:146px!important}#mainNav{gap:4px!important}#mainNav>a:not(.smv-header-action){font-size:13px!important;padding:0 7px!important;min-height:36px}#mainNav .smv-header-action{font-size:13px!important;min-height:40px}#mainNav a.smv-find-nav{padding:0 11px!important}#mainNav a.smv-header-phone{padding:0 9px!important;gap:5px}#mainNav a.smv-owner-nav-offer{padding:0 11px!important}}
      @media(max-width:1450px){#mainNav a[href="#aiPlanner"],#mainNav a[href="delhi-ncr-venues.html"]{display:none!important}.brand{width:150px!important;flex-basis:150px!important}.brand img{width:142px!important}#mainNav>a:not(.smv-header-action){font-size:13px!important;padding:0 8px!important}}
