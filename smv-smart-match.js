(function(){
  ...
  function installEnquiryStyles(){
    ...
    style.textContent=`
      ...
      .smv-consent-wrap{display:grid;gap:9px;margin:15px 0 13px;padding:13px 14px;border:1px solid rgba(25,216,189,.17);border-radius:13px;background:linear-gradient(145deg,rgba(25,216,189,.035),rgba(255,255,255,.018))}.smv-consent-row{display:flex;align-items:flex-start;gap:10px;color:#c9dedb;font-size:11.5px;line-height:1.45;font-weight:650;cursor:pointer}.smv-consent-row input{appearance:none;-webkit-appearance:none;flex:0 0 18px;width:18px!important;height:18px!important;min-height:18px!important;margin:0!important;padding:0!important;border:1px solid rgba(25,216,189,.52)!important;border-radius:5px!important;background:#03231f!important;display:grid!important;place-items:center!important;cursor:pointer!important}.smv-consent-row input:checked{background:linear-gradient(135deg,#22d9c0,#0b9b87)!important;border-color:#22d9c0!important}.smv-consent-row input:checked::after{content:"✓";color:#fff;font-size:12px;font-weight:1000;line-height:1}.smv-consent-row a{color:#55e5d1!important;text-decoration:underline!important;text-underline-offset:2px!important;font-weight:850!important}.smv-consent-row.whatsapp{padding-top:8px;border-top:1px solid rgba(255,255,255,.06);color:#dff7ef}.smv-wa-icon{display:inline-grid;place-items:center;width:21px;height:21px;margin-right:2px;border-radius:50%;background:#25D366;color:#fff;font-size:11px;font-weight:1000;vertical-align:-2px}.smv-consent-help{margin:0 0 0 28px;color:#83aaa4;font-size:9.8px;line-height:1.4}.smv-consent-error{display:none;margin-top:-4px;color:#ffb8b8;font-size:10.5px;font-weight:800}.smv-consent-error.show{display:block}
  ...
  function makeSimpleLuxuryForm(){
    ...
    if(submit && !byId("smvConsentWrap")){
      ...
      consent.innerHTML='<label class="smv-consent-row"><input id="smvPrivacyConsent" type="checkbox" aria-required="true"><span>I agree to the <a href="privacy.html" target="_blank" rel="noopener">Privacy Policy</a> and <a href="terms.html" target="_blank" rel="noopener">Terms</a>, and allow Select My Venue to use my event details to help identify suitable venues and share my requirement with relevant venue partners.</span></label><div id="smvConsentError" class="smv-consent-error">Please confirm the privacy consent to submit your requirement.</div><label class="smv-consent-row whatsapp"><input id="smvWhatsappOptIn" type="checkbox"><span><span class="smv-wa-icon">WA</span> Send me suitable venue details and enquiry updates on WhatsApp.</span></label><p class="smv-consent-help">Optional. You can submit the enquiry without choosing WhatsApp updates.</p>';
  ...
  function enhanceConfirmation(){
    ...
    var observer=new MutationObserver(function(){
      ...
      var waText=wa&&wa.checked?" You also chose to receive suitable venue details and enquiry updates on WhatsApp.":"";
