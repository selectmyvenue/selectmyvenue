(function(){
  ...
  function installEnquiryStyles(){
    ...
    style.textContent=`
      html body .site-header{min-height:68px!important}
      html body .header-inner{min-height:68px!important}
      html body .brand{width:178px!important;flex:0 0 178px!important;height:64px!important}
      html body .brand img,html body .main-logo{width:170px!important;max-width:170px!important;max-height:58px!important;object-fit:contain!important;filter:drop-shadow(0 5px 13px rgba(0,0,0,.16))!important}
      #enquiry{display:block!important;width:min(1600px,calc(100% - 28px))!important;max-width:1600px!important;margin:28px auto 44px!important;padding:34px 28px 38px!important;border:1px solid rgba(25,216,189,.25)!important;border-radius:26px!important;background:radial-gradient(circle at 8% 5%,rgba(25,216,189,.10),transparent 30%),radial-gradient(circle at 92% 4%,rgba(243,200,75,.08),transparent 25%),linear-gradient(145deg,#052925,#031f1d 55%,#021917)!important;box-shadow:0 26px 66px rgba(0,0,0,.26),inset 0 1px 0 rgba(255,255,255,.035)!important}
      #enquiry::before{display:none!important;content:none!important}
      #enquiry>.section-heading{display:flex!important;max-width:1480px!important;margin:0 auto 22px!important;align-items:end!important;justify-content:space-between!important;gap:28px!important}
      #enquiry>.section-heading>div{max-width:820px!important}#enquiry>.section-heading>p{max-width:520px!important;margin:0!important;color:#a9cbc6!important;font-size:14px!important;line-height:1.55!important;font-weight:650!important}
      ...
      #customerEnquiryForm .primary-btn[type="submit"],#customerEnquiryForm button[type="submit"]{width:auto!important;min-width:330px!important;max-width:440px!important;min-height:52px!important;padding:0 26px!important;border-radius:13px!important;background:linear-gradient(135deg,#f8d665,#e9b92e)!important;color:#241b02!important;font-size:14px!important;font-weight:1000!important;letter-spacing:.01em!important;box-shadow:0 11px 26px rgba(243,200,75,.18),inset 0 1px 0 rgba(255,255,255,.45)!important;transition:.2s ease!important}#customerEnquiryForm button[type="submit"]:hover{transform:translateY(-1px)!important;filter:brightness(1.04)!important;box-shadow:0 15px 30px rgba(243,200,75,.24),inset 0 1px 0 rgba(255,255,255,.52)!important}
      .smv-optional-field{display:none!important}.smv-optional-open .smv-optional-field{display:grid!important}.smv-more-preferences{margin:16px 0 5px;padding:10px 14px;border:1px solid rgba(25,216,189,.26);border-radius:11px;background:linear-gradient(145deg,rgba(25,216,189,.06),rgba(25,216,189,.025));color:#c9ebe6;font-size:12px;font-weight:900;cursor:pointer;box-shadow:inset 0 1px 0 rgba(255,255,255,.025)}.smv-required-note{margin:10px 0 0;color:#9cc1bc;font-size:11px;line-height:1.45;font-weight:650}
      .smv-consent-wrap{display:grid;gap:0;margin:15px 0 13px;padding:5px 16px;border:1px solid rgba(45,222,198,.24);border-radius:15px;background:linear-gradient(145deg,rgba(7,53,48,.92),rgba(3,37,34,.94));box-shadow:0 12px 28px rgba(0,0,0,.11),inset 0 1px 0 rgba(255,255,255,.035)}.smv-consent-row{display:flex;align-items:center;gap:11px;min-height:47px;color:#d5e7e4;font-size:11.7px;line-height:1.42;font-weight:680;cursor:pointer}.smv-consent-row input{appearance:none;-webkit-appearance:none;flex:0 0 20px;width:20px!important;height:20px!important;min-height:20px!important;margin:0!important;padding:0!important;border:1.5px solid rgba(39,219,193,.62)!important;border-radius:6px!important;background:#03231f!important;display:grid!important;place-items:center!important;cursor:pointer!important;box-shadow:inset 0 1px 3px rgba(0,0,0,.22)!important}.smv-consent-row input:checked{background:linear-gradient(135deg,#24dfc4,#0b9b87)!important;border-color:#35e5cc!important;box-shadow:0 0 0 3px rgba(25,216,189,.08)!important}.smv-consent-row input:checked::after{content:"✓";color:#fff;font-size:13px;font-weight:1000;line-height:1}.smv-consent-row a{color:#5ee8d5!important;text-decoration:underline!important;text-underline-offset:2px!important;font-weight:900!important}.smv-consent-row.whatsapp{border-top:1px solid rgba(255,255,255,.065);color:#effbf8;font-weight:850}.smv-consent-help{margin:-2px 0 8px 31px;color:#82aaa4;font-size:9.5px;line-height:1.35;font-weight:650}.smv-consent-error{display:none;margin:0 0 7px 31px;color:#ffc2c2;font-size:10.5px;font-weight:850}.smv-consent-error.show{display:block}
      #customerEnquiryMessage{display:none!important;margin:16px 0 3px!important;padding:16px 18px!important;border-radius:14px!important;font-size:14px!important;line-height:1.45!important;font-weight:800!important}#customerEnquiryMessage.success{display:block!important;border:1px solid rgba(94,211,157,.48)!important;background:linear-gradient(135deg,rgba(206,255,229,.18),rgba(116,232,178,.09))!important;color:#e9fff3!important;box-shadow:0 14px 30px rgba(0,0,0,.12),inset 0 1px 0 rgba(255,255,255,.10)!important}#customerEnquiryMessage.error{display:block!important;border:1px solid rgba(255,111,111,.36)!important;background:rgba(255,90,90,.07)!important;color:#ffd2d2!important}.smv-confirmation-title{display:block!important;margin-bottom:4px!important;color:#dfffea!important;font-size:17px!important;font-weight:1000!important}.smv-confirmation-sub{display:block!important;color:#bcebd0!important;font-size:12px!important;font-weight:700!important}
      ...
      @media(max-width:1650px){html body .brand{width:164px!important;flex-basis:164px!important}html body .brand img,html body .main-logo{width:156px!important;max-width:156px!important}}
      ...
      @media(max-width:680px){html body .brand{width:150px!important;flex-basis:150px!important}html body .brand img,html body .main-logo{width:142px!important;max-width:142px!important}#enquiry{width:calc(100% - 14px)!important;margin:18px auto 28px!important;padding:25px 10px 30px!important;border-radius:19px!important}#enquiry>.section-heading{display:block!important;margin-bottom:16px!important;padding:0 6px!important}#enquiry>.section-heading h2{font-size:31px!important}#enquiry>.section-heading>p{margin-top:9px!important;font-size:13px!important}#enquiry .section-kicker{font-size:10px!important}#customerEnquiryForm{padding:14px!important;border-radius:16px!important}#customerEnquiryForm .form-grid{grid-template-columns:1fr!important;gap:12px!important}.smv-ai-form-banner{padding:14px!important}.smv-ai-form-banner strong{font-size:17px!important}.smv-ai-form-banner p{font-size:12px!important}.smv-ai-live span{font-size:10px!important;padding:6px 9px!important}#customerEnquiryForm .form-section-title{font-size:12px!important}#customerEnquiryForm .field label{font-size:11px!important}#customerEnquiryForm .field input,#customerEnquiryForm .field select,#customerEnquiryForm .field textarea{font-size:14px!important;min-height:48px!important}#customerEnquiryForm #plannerSummaryPreview{font-size:11px!important}.smv-more-preferences{font-size:11px!important}.smv-required-note{font-size:10px!important}.smv-consent-wrap{padding:5px 11px}.smv-consent-row{font-size:10.8px;min-height:50px;align-items:flex-start;padding-top:11px;padding-bottom:11px}.smv-consent-help{font-size:9.2px;margin-left:31px}#customerEnquiryMessage{font-size:13px!important}#customerEnquiryForm .primary-btn[type="submit"],#customerEnquiryForm button[type="submit"]{width:100%!important;min-width:0!important;max-width:none!important;min-height:50px!important;font-size:14px!important}.home-venue-actions{grid-template-columns:1fr 1fr!important}}
    `;
  ...
  function makeSimpleLuxuryForm(){
    ...
    if(submit && !byId("smvConsentWrap")){
      var consent=document.createElement("div");
      consent.id="smvConsentWrap";
      consent.className="smv-consent-wrap";
      consent.innerHTML='<label class="smv-consent-row"><input id="smvPrivacyConsent" type="checkbox" aria-required="true"><span>I agree to the <a href="privacy.html" target="_blank" rel="noopener">Privacy Policy</a> and <a href="terms.html" target="_blank" rel="noopener">Terms</a> and allow Select My Venue to use and share my event requirement with suitable venue partners.</span></label><div id="smvConsentError" class="smv-consent-error">Please confirm the privacy consent to submit your requirement.</div><label class="smv-consent-row whatsapp"><input id="smvWhatsappOptIn" type="checkbox"><span>Send the details on WhatsApp as well.</span></label><p class="smv-consent-help">Optional — choose this if you want suitable venue details and enquiry updates on WhatsApp.</p>';
      submit.parentNode.insertBefore(consent,submit);
    }

    if(form.dataset.smvConsentBound!=="1"){
      form.dataset.smvConsentBound="1";
      form.addEventListener("submit",function(event){
        var privacy=byId("smvPrivacyConsent");
        var error=byId("smvConsentError");
        ...
        var requirements=byId("customerRequirements");
        if(requirements){
          var base=String(requirements.value||"").replace(/\n?WhatsApp updates preference: (Yes|No)\.?/gi,"").trim();
          var whatsapp=byId("smvWhatsappOptIn");
          var marker="WhatsApp updates preference: "+(whatsapp&&whatsapp.checked?"Yes":"No")+".";
          requirements.value=(base?base+"\n":"")+marker;
        }
      },true);
      var privacy=byId("smvPrivacyConsent");
      if(privacy)privacy.addEventListener("change",function(){if(privacy.checked){var error=byId("smvConsentError");if(error)error.classList.remove("show");}});
    }
  ...
  function enhanceConfirmation(){
    ...
    var observer=new MutationObserver(function(){
      ...
      message.textContent='Requirement received! Thank you for choosing Select My Venue. Our venue team will review your event details and contact you as soon as possible during support hours.';
    });
