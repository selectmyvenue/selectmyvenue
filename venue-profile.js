(function () {
  ...
  const PREMIUM_SUCCESS = "✓ Requirement received successfully. Thank you — our team will review your event details and call you within 1–2 hours with suitable venue options.";
  ...
  function installQuickEnquiryStyles(){
    ...
    const style=document.createElement("style");style.id="venueQuickEnquiryStyles";style.textContent=`
      body.venue-profile-page{font-size:13px!important;line-height:1.5!important}.venue-profile-page p,.venue-profile-page li,.venue-profile-page a,.venue-profile-page button,.venue-profile-page input,.venue-profile-page select,.venue-profile-page textarea{font-size:12.5px!important}.venue-breadcrumbs{font-size:11.5px!important}.venue-profile-titlebar h1,#venueProfileName{font-size:clamp(29px,3.2vw,44px)!important}.venue-profile-location{font-size:13px!important;font-weight:800!important}.venue-profile-facts span{font-size:9.5px!important}.venue-profile-facts strong{font-size:13px!important}.venue-profile-panel h2,.venue-profile-enquiry h2{font-size:clamp(21px,2.1vw,30px)!important}.venue-profile-panel>p:last-child,.venue-profile-enquiry>p,#venueProfileDescription{font-size:12.5px!important;line-height:1.5!important}.venue-profile-feature strong,.venue-highlight span{font-size:12.5px!important;line-height:1.42!important}.venue-highlight b{font-size:13px!important}.button,.venue-profile-page button,.venue-profile-page a.button{font-size:12.5px!important}.venue-profile-details-strip{display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:9px!important;margin:12px 0!important;padding:12px!important;border:1px solid rgba(45,210,189,.18)!important;border-radius:18px!important;background:linear-gradient(145deg,rgba(12,44,40,.95),rgba(5,30,27,.98))!important}.venue-profile-detail-item{display:grid!important;grid-template-columns:34px 1fr!important;grid-template-rows:auto auto!important;gap:2px 9px!important;align-items:center!important;min-height:58px!important;padding:10px!important;border:1px solid rgba(255,255,255,.08)!important;border-radius:13px!important;background:rgba(255,255,255,.035)!important}.venue-profile-detail-item b{grid-row:1/3;width:34px;height:34px;display:grid;place-items:center;border-radius:50%;background:rgba(45,210,189,.10);color:#2dd2bd;font-size:16px}.venue-profile-detail-item span{color:#9fc1bc;font-size:9.5px!important;font-weight:950;letter-spacing:.07em;text-transform:uppercase}.venue-profile-detail-item strong{color:#f3fbfa;font-size:13px!important;line-height:1.25;font-weight:900}.venue-profile-enquiry{position:sticky!important;top:90px!important;align-self:start!important}.venue-quick-enquiry-form{display:grid;gap:8px;margin:10px 0 8px;padding:13px;border:1px solid #dfe9e5;border-radius:14px;background:#fff;box-shadow:0 8px 22px rgba(18,56,50,.045)}.venue-quick-title{color:#123f37;font-size:17px!important;font-weight:950;margin-bottom:0}.venue-quick-subtitle{margin:-2px 0 4px;color:#5f746e;font-size:11.5px!important;line-height:1.35;font-weight:750}.venue-quick-enquiry-form label{display:grid;gap:5px}.venue-quick-enquiry-form label span{color:#59766f;font-size:9.5px!important;font-weight:900;letter-spacing:.06em;text-transform:uppercase}.venue-quick-enquiry-form input,.venue-quick-enquiry-form select{width:100%;box-sizing:border-box;border:1px solid #d9e5e1;border-radius:10px;background:#fbfdfc;color:#173f37;font:inherit;font-size:12.5px!important;font-weight:700;outline:none;height:40px;padding:0 10px}.venue-quick-row{display:grid;grid-template-columns:1fr 1fr;gap:8px}.venue-quick-enquiry-form button{height:44px;min-height:44px;border:0;border-radius:11px;background:linear-gradient(135deg,#0fbaa3,#087f71);color:#fff;font-size:13px!important;font-weight:950;cursor:pointer;box-shadow:0 9px 22px rgba(8,127,113,.18);display:flex!important;align-items:center!important;justify-content:center!important}.venue-quick-enquiry-form button:disabled{opacity:.65;cursor:wait}.venue-quick-status{min-height:18px;font-size:13px!important;line-height:1.4;font-weight:850}.venue-quick-status.success,.venue-quote-status.success{position:relative!important;display:block!important;margin:12px 0 8px!important;padding:16px 18px 16px 52px!important;border:1px solid rgba(39,166,116,.28)!important;border-radius:16px!important;background:linear-gradient(135deg,#effff8 0%,#f7fffb 58%,#fffbea 100%)!important;color:#075a43!important;font-size:13.5px!important;font-weight:850!important;line-height:1.45!important;box-shadow:0 14px 34px rgba(5,95,72,.12),inset 0 1px 0 rgba(255,255,255,.85)!important;text-shadow:none!important}.venue-quick-status.success:before,.venue-quote-status.success:before{content:'✓'!important;position:absolute!important;left:16px!important;top:14px!important;width:24px!important;height:24px!important;display:grid!important;place-items:center!important;border-radius:50%!important;background:linear-gradient(135deg,#19c99b,#0b8b69)!important;color:#fff!important;font-size:15px!important;font-weight:950!important;box-shadow:0 6px 14px rgba(12,139,105,.25)!important}.venue-quick-status.success:after,.venue-quote-status.success:after{content:'Our team will review your requirement and call you within 1–2 hours with suitable venue options.'!important;display:block!important;margin-top:4px!important;color:#24705c!important;font-size:12px!important;font-weight:700!important;line-height:1.45!important}.venue-quick-status.error,.venue-quote-status.error{color:#b42318;font-weight:850}.venue-quote-card{max-height:min(92vh,680px)!important;overflow:auto!important}.venue-quote-submit,#venueQuoteSubmit{display:flex!important;visibility:visible!important;opacity:1!important;position:sticky!important;bottom:0!important;z-index:5!important;width:100%!important;min-height:46px!important;margin-top:12px!important;align-items:center!important;justify-content:center!important}#venueProfileQuoteAside{display:none!important}.venue-profile-enquiry>.venue-assist-points{margin-top:10px!important}.venue-profile-enquiry>small{display:block;margin-top:8px!important;font-size:11px!important}
