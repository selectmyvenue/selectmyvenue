...
/* =====================================================
   ...
   Visual-only helper. Does not touch Supabase/CRM logic.
   ===================================================== */
(function setupWhatsAppQuickAction(){
  function mount(){
    if (document.getElementById("smvWhatsAppFloat")) return;

    const link = document.createElement("a");
    link.id = "smvWhatsAppFloat";
    link.className = "smv-whatsapp-float";
    link.href = "https://wa.me/919958716688";
    link.target = "_blank";
